...
@section('content')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <div>
            <ol class="breadcrumb fs-sm mb-1">
                ...
                <li class="breadcrumb-item"><a href="{{ route('admin.penilaian_video_sudah.index') }}">Daftar Penilaian Video
                        (Sudah)</a></li>
            </ol>
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            ...
            <p><strong>URL Video:</strong> <a href="{{ $video->url }}" target="_blank"
                    class="text-primary">{{ $video->url }} <i class="ri-external-link-line"></i></a></p>
        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <p><strong>Tanggal Dinilai:</strong>
                        {{ $video->tanggal_update ? date('d-m-Y H:i', strtotime($video->tanggal_update)) : '-' }}</p>
                </div>
                <div class="col-md-6">
                    <p><strong>Nilai Akhir Video:</strong> <span
                            class="fs-4 fw-bold text-success">{{ number_format($peserta->nilai_video ?? 0, 2) }}</span></p>
                </div>
            </div>
